...
function Menu() {
  ...
  let filteredFoods = foods.filter((food) => {
    return (
      ...
      (filterType ? food.type === filterType : true) &&
  ...
  const decrease = (food) => {
    setQuantities((prev) => ({
      ...prev,
      [food._id]: prev[food._id] > 0 ? prev[food._id] - 1 : 0,
    }));
  };
  ...
  return (
    <div className="bg-[#eff6ff] min-h-screen">
      <div className="max-w-6xl mx-auto px-10 py-12">
        ...
        <h1 className="text-4xl font-heading text-gray-800 mb-6">
          Explore Our <span className="text-blue-400">Menu</span>
        </h1>
        ...
        <div className="flex justify-between items-center gap-6 mb-6">
          <input
            ...
            className="border border-gray-800 rounded-lg px-4 py-2 w-1/2 focus:ring-2 focus:ring-blue-400"
          />

          <select
            value={sortOption}
            onChange={(e) => setSortOption(e.target.value)}
            className="border border-gray-800 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400"
          >
            ...
            <button
              ...
              className={`px-5 py-2 rounded-full border transition ${
                selectedCategory === cat
                  ...
                  : "border-gray-800 text-gray-800 hover:bg-[#0f172a] hover:text-white"
              }`}
            >
              {cat}
            </button>
          ...
          {filteredFoods.map((food) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-gray-800 opacity-70 text-sm">
                ...
                <div className="flex justify-between items-center mt-4">
                  ...
                  {qty === 0 ? (
                    <button
                      ...
                      className="bg-blue-400 text-white px-4 py-2 rounded-lg hover:opacity-90"
                    >
                      Add
                    </button>
                  ) : (
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="bg-[#0f172a] text-white px-3 py-1 rounded"
                      >
                        -
                      </button>
