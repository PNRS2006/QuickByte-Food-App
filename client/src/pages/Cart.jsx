  ...
  return (
    <div className="bg-[#eff6ff] min-h-screen">
      <div className="max-w-6xl mx-auto px-10 py-12">
        ...
        <h1 className="text-4xl font-heading text-[#0f172a] mb-10">
          Your <span className="text-blue-400">Cart</span>
        </h1>

        {cartItems.length === 0 ? (
          <div className="bg-white p-10 rounded-xl shadow-md text-center">
            <p className="text-[#0f172a] opacity-70 text-lg">
              Your cart is empty.
            </p>
            <button
              onClick={() => navigate("/menu")}
              className="mt-4 bg-blue-400 text-white px-6 py-2 rounded-lg font-semibold hover:opacity-90"
            >
              Browse Menu
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              {cartItems.map((item) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <div>
                      <h2 className="text-xl font-heading text-[#0f172a]">
                        {item.name}
                      </h2>
                      <p className="text-[#0f172a] opacity-70">
                        ₹ {item.price}
                      </p>
                    </div>
                  </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md h-fit">
              ...
              <h2 className="text-2xl font-heading text-[#0f172a] mb-6">
                Order Summary
              </h2>
              ...
              <textarea
                ...
                className="w-full mt-6 p-3 border rounded-lg focus:ring-2 focus:ring-blue-400"
                rows={3}
              />
              ...
              <button
                ...
                className={`mt-6 w-full bg-blue-400 text-white py-3 rounded-lg font-semibold transition ${
